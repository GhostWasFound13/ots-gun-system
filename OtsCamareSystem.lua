    ...
    local dataTable = setmetatable(
        {
            ...
            CameraSettings = {
                DefaultShoulder = {
                    ...
                    Sensitivity = 3,
                    LerpSpeed = 0.1, -- Adjust this value to control the smoothness (lower values = smoother)
                },
...
function CLASS:Update(deltaTime)
    ...
    if (humanoidRootPart ~= nil) then
        ...
        local raycastResult = workspace:Raycast(
                ...
                currentCameraCFrame.p - humanoidRootPart.Position,
                raycastParams
        )
        ----
        ...
        if (raycastResult ~= nil) then
            ...
            local x, y, z, r00, r01, r02, r10, r11, r12, r20, r21, r22 = currentCameraCFrame:components()
            currentCameraCFrame = CFrame.new(obstructionPosition.x, obstructionPosition.y, obstructionPosition.z, r00, r01, r02, r10, r11, r12, r20, r21, r22)
            currentCamera.CFrame = currentCameraCFrame
        end
        ----
